...
CREATE TABLE ACTIVIDADES(
    ...
    TIPO VARCHAR2(24) NOT NULL CONSTRAINT TIPO_ACTIVIDADES_CK CHECK (TIPO = 'SALIDA AL MONTE' OR TIPO = 'ALBERGUE FIN DE SEMANA' OR TIPO = 'REUNION' OR TIPO = 'COMIDA' OR TIPO = 'OTROS'),
    ...
    COD_SOCIO_APUNTADO NUMBER(9) CONSTRAINT SOC_APUNTADO_FK REFERENCES SOCIOS(COD_SOC),--> SOCIO APUNTADO, TIENE QUE ESTAR REFERIDO A --> "COD_SOC" DE LA TABLA SOCIOS
...
INSERT INTO SOCIOS VALUES(INCREMENTO_SOCIO.NEXTVAL,'raul','garcia',123456789,DEFAULT,945241393,'raul','26/08/1996',DEFAULT,NULL,'12345',NULL,NULL,NULL,DEFAULT,DEFAULT,DEFAULT,NULL);
INSERT INTO SOCIOS VALUES(INCREMENTO_SOCIO.NEXTVAL,'alvaro','RUIZ','1234578A',SYSDATE,623586975,'alv','10/05/1971','USUARIO',NULL,'12345',NULL,NULL,NULL,DEFAULT,'NO',DEFAULT,'Primer socio Fundador de la Asociación de Montaña "Mendi Taldea"');--> ALUMNO RESPONSABLE MAYOR DE 18  -->OK
COMMIT;
